...
int main()
{
    ...
    {
        /* set nodes */
        conhash_set_node(&g_nodes[0], "titanic", 128);
        conhash_set_node(&g_nodes[1], "terminator2018", 128);
        conhash_set_node(&g_nodes[2], "Xenomorph", 128);
        conhash_set_node(&g_nodes[3], "True Lies", 128);
        conhash_set_node(&g_nodes[4], "avantar", 128);
